...
class PostActivity : AppCompatActivity() {
    ...
    private val launcherIntentCameraX = registerForActivityResult(
        ...
        if (it.resultCode == MainActivity.CAMERA_X_RESULT) {
            ...
            myFile?.let { file ->
                ...
                binding.vPreviewImage.visibility = View.INVISIBLE
                binding.ivImagePlaceholder.visibility = View.INVISIBLE
            }
        }
    }
    ...
    private fun obtainViewModel(activity: PostActivity): PostViewModel {
        val factory = ViewModelFactory.getInstance(activity.application, pref, this@PostActivity)
